...
namespace ZXing.Common
{
    ...
    public sealed class BitArrayTests
    {
        ...
        public void ReverseAlgorithmTest()
        {
            ...
            for (var size = 1; size < 160; size++) {
                ...
                if (!arrays_are_equal(newBitsOriginal, newBitsNew, size / 32 + 1)) {
                    ...
                    System.Diagnostics.Debug.WriteLine(BitsToString(oldBits, size));
                    System.Diagnostics.Debug.WriteLine(BitsToString(newBitsOriginal, size));
                    System.Diagnostics.Debug.WriteLine(BitsToString(newBitsNew, size));
                }
        ...
        public void ReverseSpeedTest()
        {
            ...
            System.Diagnostics.Debug.WriteLine(endOld - startOld);
            System.Diagnostics.Debug.WriteLine(endNew - startNew);
        }
