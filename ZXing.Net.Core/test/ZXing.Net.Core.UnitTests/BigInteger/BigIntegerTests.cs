...
namespace BigIntegerLibrary
{
    ...
    public sealed class BigIntegerTests
    {
        ...
        {
            var left = BigInteger.Parse(number).ToString();
        ...
        public void System_Numerics_BigInteger_And_BigIntegerLibrary_Should_Be_The_Same(string number)
        {
            ...
            var libraryBigInt900 = new BigInteger(900);
            var systemBigInt = BigInteger.Parse(number);
            var libraryBigInt = BigInteger.Parse(number);

            var systemResult = systemBigInt % systemBigInt900;
            var libraryResult = BigInteger.Modulo(libraryBigInt, libraryBigInt900);
